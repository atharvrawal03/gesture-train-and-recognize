...
# All models - FIXED: use keyword arguments for n_estimators
models = {
    ...
    'XGB': xgb.XGBClassifier(n_estimators=100, eval_metric='mlogloss'),
...
for name, mdl in models.items():
    if name == best:
        ...
        print(f"✅ Best model ({best}) saved as best_model.pkl")
        break
